...
RORE is a Redis-first agent bridge for distributed AI networks. It uses Redis Streams for live agent messages and keeps the original file bridge as fallback and audit trail.
...
Redis should stay bound to `127.0.0.1:6379`, DB 15 by default. Do not expose Redis publicly. Local nodes should reach it through an SSH tunnel.
...
- Local nodes should connect through SSH tunnel only.
